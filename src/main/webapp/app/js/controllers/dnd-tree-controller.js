angular.module("hello").controller(
		...
		[
				...
				function($scope, $TreeDnDConvert) {
					...
					// FIXME 
					// Problem with $http that wraps response within data so
					// failed to get the gridTemplate needs data.data to get it
					// fix might be global settings of $http service

					$scope.tree_data = $TreeDnDConvert.line2tree(data,
